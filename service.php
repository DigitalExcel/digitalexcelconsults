...
================================================== -->
  <section id="service-page" class="pages service-page">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 order-1 order-lg-2" style="margin-bottom: 2rem;">
          <div class="block">
            <img class="img-fluid" src="images/services.jpg" alt="" width="100%">
          </div>
        </div>
        <div class="col-lg-12">
...
================================================== -->
  ...
  <!-- 
        ================================================== 
            Clients Section Start
        ================================================== -->
  <?php include 'partials/our_clients.php'; ?>
