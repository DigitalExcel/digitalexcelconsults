          ...
          <div class="block wow fadeInUp" data-wow-delay=".3s">
            ...
            <section class="cd-intro">
              <h1 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s">
                <span>I just want to know whether you work&amp; I AM A</span><br>
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <div class="block wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="500ms">
            <h2>
              WELCOME TO DIGITAL EXCEL CONSULTS
            </h2>
            <p>
              Welcome to Excel, where we equip Liberians with the necessary skills and knowledge
              to embrace technology and contribute to a thriving digital society. We firmly believe i
              n empowering individuals, bridging the digital divide, and paving the way for a prosperous
...
================================================== -->
  <?php include 'partials/latest_work.php'; ?>
